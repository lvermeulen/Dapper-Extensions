    ...
    public class CrudFixture
    {
        ...
        public class DeleteMethod : SqlServerBaseFixture
        {
            ...
            public void UsingPredicate_DeletesRows()
            {
                ...
                bool result = Db.Delete<Person>(pred);
                Assert.True(result);
            ...
            public void UsingObject_DeletesRows()
            {
                ...
                bool result = Db.Delete<Person>(new { LastName = "Bar"} );
                Assert.True(result);
        ...
        public class GetListMethod : SqlServerBaseFixture
        {
            ...
            public void UsingPredicate_ReturnsMatching()
            {
                ...
                var list = Db.GetList<Person>(predicate).ToList();
        ...
        public class GetPageMethod : SqlServerBaseFixture
        {
            ...
            public void UsingNullPredicate_ReturnsMatching()
            {
                ...
                Db.Insert(new Person { Active = true, FirstName = "Theta", LastName = "Gamma", DateCreated = DateTime.UtcNow });
                Db.Insert(new Person { Active = false, FirstName = "Iota", LastName = "Beta", DateCreated = DateTime.UtcNow });
                ...
                var list = Db.GetPage<Person>(null, sort, 0, 2).ToList();
                Assert.Equal(2, list.Count);
            ...
            public void UsingPredicate_ReturnsMatching()
            {
                Db.Insert(new Person { Active = true, FirstName = "Sigma", LastName = "Alpha", DateCreated = DateTime.UtcNow });
                Db.Insert(new Person { Active = false, FirstName = "Delta", LastName = "Alpha", DateCreated = DateTime.UtcNow });
                Db.Insert(new Person { Active = true, FirstName = "Theta", LastName = "Gamma", DateCreated = DateTime.UtcNow });
                Db.Insert(new Person { Active = false, FirstName = "Iota", LastName = "Beta", DateCreated = DateTime.UtcNow });
                ...
                var list = Db.GetPage<Person>(predicate, sort, 0, 3).ToList();
                Assert.Equal(2, list.Count);
            ...
            public void NotFirstPage_Returns_NextResults()
            {
                ...
                var list = Db.GetPage<Person>(null, sort, 1, 2).ToList();
                Assert.Equal(2, list.Count);
